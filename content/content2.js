/**
 * content2.js
 * HackerNoon newsletter template dataset — HN JSON-authored variant.
 *
 * This is the HN JSON-authored variant of the newsletter payload.
 * Previously located at files/data-hn.js (which now re-exports from here).
 *
 * Shape:
 ...
 *   - content/content3.js  (markdown-derived variant)
 */
export default {
